...
import {
    Container, Botoes, Botao, TituloContainer, TituloSubContainer, Titulo, Subtitulo, DadosColetor, FranquiaContainer,
    FranquiaSubcontainer, FranquiaItem, FranquiaTitulo, FranquiaDado, Listagem
} from './styles'
    ...
    return (
        <Container {...{ show }}>
            <Botoes>
                ...
                <Botao onClick={() => gerarRelatorio()} hover={colors.azul} title='Gerar Relatório'> <MenuIcon name='relatorio' margin='0.8' /> </Botao>
                <Botao onClick={() => props.editarCadastros(cliente.id, props.clientes)} hover={colors.azul} title='Editar Cliente'> <MenuIcon name='usuario_editar' margin='0.8' /> </Botao>
                {compareParentData() && <Botao onClick={() => salvar()} hover={colors.azul} title='Salvar/Fechar'> <MenuIcon name='salvar' margin='0.8' /> </Botao>}
                <Botao onClick={() => fechar()} hover={colors.azul} title='Fechar'> <MenuIcon name='fechar' margin='0' /> </Botao>
            </Botoes>
            <TituloContainer>
                <TituloSubContainer>
                    <Titulo>{cliente.nomefantasia}</Titulo>
                    <Subtitulo>{cliente.razaosocial}</Subtitulo>
                </TituloSubContainer>
                <TituloSubContainer>
                    <DadosColetor>Chave do cliente: <b> {cliente.id} </b></DadosColetor>
                    <DadosColetor>Pc com coletor: <b> {window.atob(cliente.sistema.local)} </b></DadosColetor>
                    <DadosColetor>Versão do coletor: <b>  {cliente.sistema.versao} </b></DadosColetor>
                </TituloSubContainer>
            </TituloContainer>
            <Listagem>
                <FranquiaContainer>
                    <FranquiaSubcontainer border={props.user.permissoes.clientes.financeiro}>
                        <FranquiaItem>
                            <FranquiaTitulo> Tipo de franquia </FranquiaTitulo>
                            <FranquiaDado> 
                        ...
                        <FranquiaItem show={franquiaPagina}>
                            <FranquiaTitulo> Franquia </FranquiaTitulo>
                            <FranquiaDado>
                        ...
                        <FranquiaItem border={false}>
                            <FranquiaTitulo> Total impresso </FranquiaTitulo>
                            <FranquiaDado> {cliente.impresso} págs </FranquiaDado>
                        </FranquiaItem>
                    </FranquiaSubcontainer> 
                    {props.user.permissoes.clientes.financeiro && <FranquiaSubcontainer  border={false}>
                        <FranquiaItem>
                            <FranquiaTitulo> Valor por excedente </FranquiaTitulo>
                            <FranquiaDado>
                                <TextField onChange={handleDigitarVpe} value={vpe} onBlur={handleBlurVpe} />
                            </FranquiaDado>
                        </FranquiaItem>
                        <FranquiaItem border={false} bottom={false}>
                            <FranquiaTitulo> Excedentes </FranquiaTitulo>
                            <FranquiaDado>
