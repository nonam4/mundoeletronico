        ...
        for ( let dia of dias ) {
            views.push(
                <S.HorarioSubcontainer key={ dia.index }>
                    ...
                    { cadastro.horarios[ dia.index ].aberto && <S.Horario>
                        ...
                        <S.Spacer /> - <S.Spacer />
                        <S.SimpleTextField onChange={ ( e ) => handleHorarioChange( e, dia.index, 1 ) } value={ getHorario( dia.index, 1 ) } maxLength={ 5 } onBlur={ () => handleBlurHorario( dia.index, 1 ) } />
                    </S.Horario> }
                    { cadastro.horarios[ dia.index ].aberto && duasLinhasHorarios( dia.index ) && <S.Horario>
                        <S.SimpleTextField onChange={ ( e ) => handleHorarioChange( e, dia.index, 2 ) } value={ getHorario( dia.index, 2 ) } maxLength={ 5 } onBlur={ () => handleBlurHorario( dia.index, 2 ) } />
                        <S.Spacer /> - <S.Spacer />
        ...
        <S.Container expanded={ props.expanded } desktop={ props.desktop }>
            ...
            <S.View>
                ...
                <S.TituloContainer>
                    ...
                    <div>
                        <S.DadosColetor>Chave do cliente: <b> { cadastro.id } </b></S.DadosColetor>
                ...
                <S.LinhaContainer>
                    <S.LinhaSubContainer>
                        <S.Linha> <TextField placeholder={ 'Nome Fantasia' } onChange={ ( e ) => handleInput( e, 'nomefantasia' ) } value={ cadastro.nomefantasia } icon={ false } maxLength={ 50 } /> </S.Linha>
                        <S.Linha> <TextField placeholder={ 'Razão Social' } onChange={ ( e ) => handleInput( e, 'razaosocial' ) } value={ cadastro.razaosocial } icon={ false } maxLength={ 50 } /> </S.Linha>

                        <S.SubLinha>
                            <S.Linha minWidth={ '140px' } maxWidth={ '140px' }> <TextField placeholder={ 'CPF/CNPJ' } onChange={ ( e ) => formatarCpfcnpj( e, 'cpfcnpj' ) } value={ cadastro.cpfcnpj } icon={ false } /> </S.Linha>
                            <S.Spacer />
                            <S.Linha> <TextField placeholder={ 'Email' } onChange={ ( e ) => handleInput( e, 'contato.email' ) } value={ cadastro.contato.email } icon={ false } maxLength={ 50 } /> </S.Linha>
                        </S.SubLinha>

                        <S.Linha>
                            <S.Linha> <TextField placeholder={ 'Telefone' } onChange={ ( e ) => formatarTelefone( e, 'contato.telefone' ) } value={ cadastro.contato.telefone } icon={ false } /> </S.Linha>
                            <S.Spacer />
                            <S.Linha> <TextField placeholder={ 'Celular' } onChange={ ( e ) => formatarCelular( e, 'contato.celular' ) } value={ cadastro.contato.celular } icon={ false } /> </S.Linha>
                        </S.Linha>
                    </S.LinhaSubContainer>
                </S.LinhaContainer>
                ...
                <S.LinhaContainer>
                    <S.LinhaSubContainer>
                        <S.Linha>
                            <S.Linha> <TextField placeholder={ 'Rua' } onChange={ ( e ) => handleInput( e, 'endereco.rua' ) } value={ cadastro.endereco.rua } icon={ false } maxLength={ 50 } /> </S.Linha>
                            <S.Spacer />
                            <S.Linha important={ true } minWidth={ '65px' } maxWidth={ '65px' }> <TextField placeholder={ 'Número' } onChange={ ( e ) => formatarNumero( e, 'endereco.numero' ) } value={ cadastro.endereco.numero } icon={ false } maxLength={ 5 } /> </S.Linha>
                        </S.Linha>

                        <S.SubLinha>
                            <S.Linha> <TextField placeholder={ 'Complemento' } onChange={ ( e ) => handleInput( e, 'endereco.complemento' ) } value={ cadastro.endereco.complemento } icon={ false } maxLength={ 100 } /> </S.Linha>
                        </S.SubLinha>

                        <S.SubLinha>
                            <S.Linha> <TextField placeholder={ 'Bairro' } onChange={ ( e ) => handleInput( e, 'endereco.bairro' ) } value={ cadastro.endereco.bairro } icon={ false } maxLength={ 50 } /> </S.Linha>
                            <S.Spacer />
                            <S.Linha margin={ 'none' } maxWidth={ 'fit-content' }>
                                <S.Linha> <TextField placeholder={ 'Cidade' } onChange={ ( e ) => handleInput( e, 'endereco.cidade' ) } value={ cadastro.endereco.cidade } icon={ false } maxLength={ 50 } /> </S.Linha>
                                <S.Spacer />
                                <S.Linha important={ true } minWidth={ '38px' } maxWidth={ '38px' }> <TextField placeholder={ 'UF' } onChange={ ( e ) => formatarEstado( e, 'endereco.estado' ) } value={ cadastro.endereco.estado.toUpperCase() } icon={ false } maxLength={ 2 } /> </S.Linha>
                                <S.Spacer />
                                <S.Linha important={ true } minWidth={ '82px' } maxWidth={ '82px' }> <TextField placeholder={ 'CEP' } onChange={ ( e ) => formatarCep( e, 'endereco.cep' ) } value={ cadastro.endereco.cep } icon={ false } /> </S.Linha>
                            </S.Linha>
                        </S.SubLinha>
                    </S.LinhaSubContainer>
                </S.LinhaContainer>
