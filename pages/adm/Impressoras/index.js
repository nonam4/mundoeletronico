...
function Impressoras() {
    ...
    async function salvarExpandido(cliente) {
        ...
        await axios.post('/api/salvarcliente', { usuario: props.user, cliente }).then(() => {
    ...
    return (
        <S.Container expanded={expandido} desktop={sempreVisivel}>
            <Header {...props} >
                <DropDown {...{ ...props, filters, setFilters, filterDefaults, busca, setBusca, getDatas, searchRef }} />
            </Header>
